...
// Visão do calendário (mês/ano navegáveis)
let calendarViewMonth = null; // 0-11
let calendarViewYear = null;  // ex.: 2025
// Galeria: arquivos de apresentação da clínica
const GALLERY_IMAGES = [
    'PHOTO-2025-10-30-09-08-05.jpg',
    'PHOTO-2025-10-30-09-08-08.jpg',
    'PHOTO-2025-10-30-09-08-10.jpg',
    'PHOTO-2025-10-30-09-08-11.jpg',
    'PHOTO-2025-10-30-09-08-12.jpg',
    'PHOTO-2025-10-30-09-08-12(1).jpg',
    'PHOTO-2025-10-30-09-08-12(2).jpg',
    'PHOTO-2025-10-30-09-08-12(3).jpg',
    'PHOTO-2025-10-30-09-08-13.jpg',
    'PHOTO-2025-10-30-09-08-13(1).jpg',
    'PHOTO-2025-10-30-09-08-13(2).jpg',
    'PHOTO-2025-10-30-09-08-13(3).jpg',
    'PHOTO-2025-10-30-09-08-14.jpg',
    'PHOTO-2025-10-30-09-08-14(1).jpg',
    'PHOTO-2025-10-30-09-08-14(2).jpg',
    'PHOTO-2025-10-30-09-08-14(3).jpg',
    'PHOTO-2025-10-30-09-08-15.jpg',
    'PHOTO-2025-10-30-09-08-15(1).jpg',
    'PHOTO-2025-10-30-09-08-15(2).jpg',
    'PHOTO-2025-10-30-09-08-15(3).jpg',
    'PHOTO-2025-10-30-09-08-15(4).jpg',
    'PHOTO-2025-10-30-09-08-16.jpg',
    'PHOTO-2025-10-30-09-08-16(1).jpg',
    'PHOTO-2025-10-30-09-08-16(2).jpg',
    'PHOTO-2025-10-30-09-08-16(3).jpg',
    'PHOTO-2025-10-30-09-08-17.jpg',
    'PHOTO-2025-10-30-09-08-17(1).jpg',
    'PHOTO-2025-10-30-09-08-17(2).jpg',
    'PHOTO-2025-10-30-09-08-17(3).jpg',
    'PHOTO-2025-10-30-09-08-18.jpg',
    'PHOTO-2025-10-30-09-08-18(1).jpg',
    'PHOTO-2025-10-30-09-08-18(2).jpg',
    'PHOTO-2025-10-30-09-08-18(3).jpg',
    'PHOTO-2025-10-30-09-08-19.jpg',
    'PHOTO-2025-10-30-09-08-19(1).jpg',
    'PHOTO-2025-10-30-09-08-19(2).jpg',
    'PHOTO-2025-10-30-09-08-19(3).jpg',
    'PHOTO-2025-10-30-09-08-20.jpg',
    'PHOTO-2025-10-30-09-08-20(1).jpg',
    'PHOTO-2025-10-30-09-08-20(2).jpg',
    'PHOTO-2025-10-30-09-08-20(3).jpg',
    'PHOTO-2025-10-30-09-08-20(4).jpg'
];
...
function initializeApp() {
    // Definir fisioterapeutas oficiais (substitui exemplos anteriores)
    const fisios = [
        {
            id: 1,
        ...
        {
            id: 2,
            nome: 'Isadora Fróis Campos',
            especialidade: 'Neurofuncional',
            crf: 'A06170417',
            foto: 'assets/images/profissionais/Isadora Fróis.jpg'
        },
        {
            id: 3,
        ...
        {
            id: 4,
            nome: 'Maressa Laporte de Andrade',
            especialidade: 'Geriátrica',
            crf: 'A06170055',
            foto: 'assets/images/profissionais/Meressa.jpg'
        },
        {
            id: 5,
            nome: 'Raniele das Neves Soares',
            especialidade: 'Traumato-Ortopédica e Esportiva',
            crf: 'A06167218',
            foto: 'assets/images/profissionais/Raniele.jpg'
        },
        {
            id: 6,
            nome: 'Érika Marcondes Caldeira',
            especialidade: 'Preventiva, Funcional e Pélvica',
            crf: 'A06170683',
    ...
    if (currentVersion !== fisiosVersion) {
        ...
        localStorage.setItem('fisios_version', fisiosVersion);
    }
    // Sempre rodar a migração para limpar vestígios de nomes antigos em agendamentos existentes
    migrateLegacyProfessionals();
...
// Util: ano do rodapé na landing
function setFooterYear() {
    const y = document.getElementById('yearNow');
    if (y) y.textContent = new Date().getFullYear();
}

// Renderizar galeria da clínica a partir de lista de arquivos
function renderGallery() {
    const grid = document.getElementById('galleryGrid');
    if (!grid) return;
    const base = 'assets/images/galeria/';
    // ordenar por nome para consistência
    const files = [...GALLERY_IMAGES].sort();
    grid.innerHTML = files.map((file, i) => `
        <div class="gallery-item"><img src="${base + file}" alt="Foto da clínica ${i+1}" loading="lazy"></div>
    `).join('');
}
        ...
        <div class="dashboard-container">
            ...
            <aside class="sidebar" id="sidebar">
                <div class="sidebar-header">
                    <img src="assets/images/logo.jpeg" alt="PhysioHome & Care" class="sidebar-logo"/>
                    <h3>PhysioHome</h3>
                </div>
        ...
        <div id="appointmentModal" class="modal">
            <div class="modal-content">
                ...
                <form id="appointmentForm" class="auth-form">
                    ...
                    <div class="form-group">
                        <label><i class="fas fa-building-user"></i> Tipo de Atendimento</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="appointmentLocal" required placeholder="Endereço do atendimento ou endereço da clínica">
                    </div>
...
function renderCalendar() {
    // inicializa visão se necessário
    if (calendarViewMonth === null || calendarViewYear === null) {
    ...
    return `
        <div id="calendarContainer" class="calendar-container">
            <div class="calendar-header">
                ...
                <h3>${getMonthName(calendarViewMonth)} ${calendarViewYear}</h3>
            ...
            <div class="calendar-grid">
                ...
                ${generateCalendarDays(calendarViewMonth, calendarViewYear)}
            </div>
        </div>
    `;
}
...
function previousMonth() {
    if (calendarViewMonth === null || calendarViewYear === null) return; // segurança
...
function rerenderCalendar() {
    ...
    if (!container) return;
    // Substitui o conteúdo do container por um novo calendário
    container.outerHTML = renderCalendar();
}
                ...
                <div class="appointment-item">
                    <div class="appointment-info">
                        ...
                        <div class="appointment-details">
                            <h3>${app.fisio || app.paciente} ${app.tipoAtendimento ? `<span class=\"badge ${app.tipoAtendimento==='presencial' ? 'badge-presencial' : 'badge-domiciliar'}\">${app.tipoAtendimento==='presencial' ? 'Presencial' : 'Domiciliar'}</span>` : ''}</h3>
...
function openNewAppointmentModal() {
    ...
    // Configurar mudança do tipo de atendimento
    const typeSelect = document.getElementById('appointmentType');
    const localInput = document.getElementById('appointmentLocal');
    if (typeSelect && localInput) {
        typeSelect.onchange = () => updateAppointmentLocalByType(typeSelect, localInput);
        updateAppointmentLocalByType(typeSelect, localInput);
    }
}
...
function handleNewAppointment(e) {
    ...
    const tipoAtendimento = document.getElementById('appointmentType').value;
...
function updateAppointmentLocalByType(typeSelect, localInput) {
    const CLINIC_ADDRESS = 'Clínica PhysioHome & Care - Rua Exemplo, 123, Centro';
    if (typeSelect.value === 'presencial') {
        localInput.value = CLINIC_ADDRESS;
        localInput.readOnly = true;
    } else {
        if (localInput.value === CLINIC_ADDRESS) localInput.value = '';
        localInput.readOnly = false;
        localInput.placeholder = 'Endereço do atendimento';
    }
}
...
function renderChatList() {
        const contacts = currentUser.type === 'paciente' 
                ? [
                        ...getFisioterapeutas().map(f => ({ id: f.id, nome: f.nome, tipo: 'fisioterapeuta', lastMessage: 'Olá! Precisando de algo?', online: Math.random() > 0.5 })),
                        { id: 999, nome: 'Suporte PhysioHome', tipo: 'suporte', lastMessage: 'Estamos aqui para ajudar', online: true }
                    ]
        : [
...
// Migração: substituir nomes antigos de profissionais em agendamentos
function migrateLegacyProfessionals() {
    const mapOldToNew = {
        // nomes antigos do seed inicial
        'Dr. Carlos Silva': 'Raniele das Neves Soares',
        'Dra. Ana Paula': 'Ana Paula Miranda',
        'Dr. Roberto Santos': 'Érika Marcondes Caldeira',

        // nomes curtos usados na landing anterior
        'Ana Paula': 'Ana Paula Miranda',
        'Erika': 'Érika Marcondes Caldeira',
        'Érika': 'Érika Marcondes Caldeira',
        'Gabriela': 'Gabriela Lopes Vieira',
        'Isadora Fróis': 'Isadora Fróis Campos',
        'Isadora Frois': 'Isadora Fróis Campos',
        'Meressa': 'Maressa Laporte de Andrade',
        'Maressa': 'Maressa Laporte de Andrade',
        'Raniele': 'Raniele das Neves Soares'
    };

    let appointments = JSON.parse(localStorage.getItem('appointments') || '[]');
    let changed = false;
    appointments = appointments.map(a => {
        if (a.fisio && mapOldToNew[a.fisio]) {
            changed = true;
            return { ...a, fisio: mapOldToNew[a.fisio] };
        }
        return a;
    });
    if (changed) {
